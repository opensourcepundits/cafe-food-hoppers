...
<a
	...
	class="group block border border-line bg-paper transition-colors hover:border-ink hover:bg-paper-2"
>
	{#if venue.images?.[0]}
		<img src={venue.images[0].url} alt="" class="h-40 w-full border-b border-line object-cover" />
	{/if}
	<div class="p-4">
